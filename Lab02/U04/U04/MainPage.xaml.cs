...
namespace U04
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            MessgeText.Text = "What is XAML?";
        }

        private void Page_Loaded(object sender, RowUpdatedEventArgs e)
        {
            Button myButton = new Button();
            myButton.Name = "ClickMeButton";
            myButton.Content = "Click Me";
            myButton.Width = 200; myButton.Height = 100;
            ...
            myButton.Background = new SolidColorBrush(Windows.UI.Colors.Gray);
